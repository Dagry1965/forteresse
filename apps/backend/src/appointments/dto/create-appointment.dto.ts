...
export class CreatePublicAppointmentDto {
  ...
  // pour RDV publics il n'y a généralement pas d'utilisateur interne lié
  @IsOptional()
  ...
  // statut initial pour les RDV publics sera forcé à PENDING côté serveur,
  // mais on laisse la propriété optionnelle pour compatibilité
  @IsOptional()
  @IsString({ message: "Le statut doit être une chaîne de caractères." })
  status?: string;

  // informations client (publiques)
